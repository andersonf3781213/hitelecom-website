...
const es: ServiceContent = {
  ...
  techHeading: 'Soporte técnico para cada etapa de su proyecto',
  techCards: [
    { img: 'service/tech-1.jpg', title: 'Personalización de hardware', desc: 'Personalice las variables de medición, la conectividad, la energía, las interfaces y las carcasas para su aplicación.' },
    ...
    { img: 'service/tech-3.jpg', title: 'Soporte remoto', desc: 'Reciba asistencia remota para diagnosticar y resolver incidencias, orientación de configuración y soporte de despliegue de nuestro equipo de ingeniería.' },
    ...
    { img: 'service/tech-5.jpg', title: 'Asistencia técnica in situ', desc: 'Solicite asistencia técnica in situ cuando la asistencia remota no sea suficiente.' },
  ...
  softHeading: 'Software',
  softSub1: 'Disponible en PC, app móvil, pantallas de gran formato y murales de vídeo',
  ...
  softBullets: [
    ...
    { icon: 'service/img9.png', text: 'Personalice las condiciones de activación y los tiempos de respuesta de las notificaciones de alerta por correo y app.' },
  ...
  docsP1: [
    { name: 'Perfil de la empresa', type: 'Folleto (EN)', file: '/downloads/company-profile.pdf', downName: 'Hitelecom-Company-Profile.pdf' },
    { name: 'Hitelecom Cloud', type: 'Escenarios', file: '/downloads/hitelecom-cloud-scenarios.pdf', downName: 'Hitelecom-Cloud-Scenarios.pdf' },
    { name: 'Sensor de temperatura', type: 'Folleto (EN)', file: '/downloads/temperature-sensor.jpg', downName: 'Temperature-Sensor-Brochure.jpg' },
    { name: 'Sensor de suelo', type: 'Folleto (EN)', file: '/downloads/soil-sensor.jpg', downName: 'Soil-Sensor-Brochure.jpg' },
    { name: 'Sensor de nivel sumergible', type: 'Folleto (EN)', file: '/downloads/liquid-level-sensor.jpg', downName: 'Liquid-Level-Sensor-Brochure.jpg' },
    { name: 'Sensor de presión', type: 'Folleto (EN)', file: '/downloads/pressure-sensor.jpg', downName: 'Pressure-Sensor-Brochure.jpg' },
    { name: 'Sensor de fugas de agua (proyecto personalizado)', type: 'Folleto (EN)', file: '/downloads/water-leakage-sensor.jpg', downName: 'Water-Leakage-Sensor-Brochure.jpg' },
    { name: 'Calidad del aire', type: 'Folleto (EN)', file: '/downloads/air-quality-sensor.jpg', downName: 'Air-Quality-Sensor-Brochure.jpg' },
  ],
  docsP2: [
    { name: 'Sensor de distancia por radar', type: 'Folleto (EN)', file: '/downloads/distance-measurement-sensor.jpg', downName: 'Distance-Measurement-Sensor-Brochure.jpg' },
    { name: 'Sensor 2 en 1 de temperatura para áreas peligrosas', type: 'Folleto (EN)', file: '/downloads/temperature-sensor-ex.jpg', downName: 'Temperature-Sensor-EX-Brochure.jpg' },
    { name: 'Sensor 2 en 1 de temperatura y presión para áreas peligrosas', type: 'Folleto (EN)', file: '/downloads/temp-pressure-2in1-ex.jpg', downName: 'Temp-Pressure-2in1-EX-Brochure.jpg' },
    { name: 'Sensor de temperatura y humedad', type: 'Ficha técnica (EN)', file: '/downloads/h300-temperature-humidity-sensor-datasheet.pdf', downName: 'Hitelecom-Temperature-Humidity-Sensor-Datasheet.pdf' },
    { name: 'Sensor de suelo', type: 'Ficha técnica (EN)', file: '/downloads/h300-soil-sensor-datasheet.pdf', downName: 'Hitelecom-Soil-Sensor-Datasheet.pdf' },
    { name: 'Sensor de presión', type: 'Ficha técnica (EN)', file: '/downloads/h300-pressure-sensor-datasheet.pdf', downName: 'Hitelecom-Pressure-Sensor-Datasheet.pdf' },
    { name: 'Sensor de inclinación', type: 'Ficha técnica (EN)', file: '/downloads/h310-ts180c-tilt-sensor-datasheet.pdf', downName: 'H310-TS180C-Tilt-Sensor-Datasheet.pdf' },
    { name: 'Distancia por radar', type: 'Ficha técnica (EN)', file: '/downloads/h310-mw012-radar-distance-sensor-datasheet.pdf', downName: 'H310-MW012-Radar-Distance-Sensor-Datasheet.pdf' },
    { name: 'Calidad del aire', type: 'Ficha técnica (EN)', file: '/downloads/h310-aq041-air-quality-sensor-datasheet.pdf', downName: 'H310-AQ041-Air-Quality-Sensor-Datasheet.pdf' },
  ],
