...
export const serviceContent: Record<'en' | 'zh', ServiceContent> = {
  en: {
    ...
    formPh: { name: 'Name', phone: 'Phone', email: 'Email', message: 'Tell us what you need, including the product, application, quantity, and site conditions. We will respond within one business day.' },
