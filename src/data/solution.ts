 ...
 "cards": [
  {
   ...
   "img": "solution/card-58.jpg",
   "title": "産業用IoT",
   "desc": "温度・圧力・振動・空気質などのフィールドセンサーをクラウドダッシュボードに接続し、遠隔状態モニタリング、アラート、保全計画を実現します。"
  },
  {
   "id": "65",
   "img": "solution/card-65.jpg",
   "title": "スマート農業",
   "desc": "土壌水分、温度、EC、NPK、気象・灌漑条件を監視し、データ駆動の水・作物管理を支援します。"
  },
  {
   "id": "64",
   "img": "solution/card-64.png",
   "title": "スマートキャンパス",
   "desc": "室内空気・温湿度・エネルギー使用・重要施設を、設定可能なアラートを備えた一元化プラットフォームから監視します。"
  },
  {
   "id": "60",
   "img": "solution/card-60.jpg",
   "title": "スマート工業団地",
   "desc": "複数建物のサイトで環境・エネルギー・セキュリティ・設備データを接続し、集中モニタリングと運営を実現します。"
  },
  {
   "id": "59",
   "img": "solution/card-59.png",
   "title": "スマートエネルギー",
   "desc": "エネルギー資産の温度・圧力・振動・レベルを監視し、状態基準保全を支援し、現場訪問を削減します。"
  },
  {
   "id": "57",
   "img": "solution/card-57.jpg",
   "title": "スマートシティ",
   "desc": "屋外向けセンサーターミナルとクラウドアラートで、構造傾斜、環境条件、ユーティリティ資産、公共インフラを監視します。"
  },
  {
   "id": "66",
   "img": "solution/card-66b.jpg",
   "title": "観光・文化遺産",
   "desc": "構造傾斜、環境条件、煙、来訪者の流れ、選定資産を監視し、保存とサイト運営を支援します。"
  },
  {
   "id": "67",
   "img": "solution/card-67.jpg",
   "title": "スマート水管理",
   "desc": "貯水池、ポンプ場、パイプライン、排水網の水位・圧力・流量・漏洩・環境条件を監視します。"
  }
 ]
}, es: {
 "bannerImg": "solution/index-banner.jpg",
...
{ ...solutionDetailsBase, de: {
 ...
 "58": {
  ...
  "intro": [
   {
    "img": "solution/58-intro-0.jpg",
    "h": "業界の課題",
    "p": "製造業者はコスト圧力、予定外のダウンタイム、設備状態の限られた可視性に直面しています。産業用IoTは、フィールドセンサーをクラウドダッシュボードに接続し、継続的なモニタリング、迅速な対応、データ駆動の意思決定を実現することでこれに対応します。"
   },
   {
    "img": "solution/58-intro-1.jpg",
    "h": "ソリューション概要",
    "p": "Hitelecomの産業モニタリングソリューションは、生産設備上の温度・湿度・圧力・振動・空気質センサーをHitelecom Cloudに接続します。センサーにより、チームは機械の状態をリアルタイムで監視し、異常を検出し、カレンダーではなく状態に基づいて保全を計画できます。"
   }
  ],
  "archHeading": "ソリューションアーキテクチャ",
  "archImgs": [
   "solution/58-arch-0.png"
  ],
  "featHeading": "主なメリット",
  "features": [
   {
    "h": "低消費電力設計",
    "p": "一部のセンサーターミナルは、低消費電力プロセッサー、最適化された電源管理、構成可能な送信間隔を採用し、フィールドでのバッテリー寿命を延ばします。"
   },
   {
    "h": "屋外向けオプション",
    "p": "一部のモデルは、産業・屋外環境向けのIP防護等級筐体をご用意しています。構成ごとに必要な防護等級をご確認ください。"
   },
   {
    "h": "柔軟なコネクティビティ",
    "p": "モデルと現場に応じて、直接セルラーアップリンクの4G LTEまたはNB-IoT、またはプライベートゲートウェイベースのネットワークのLoRa/LoRaWANをお選びください。"
   },
   {
    "h": "NFC設定",
    "p": "一部のデバイスはNFCアクティベーションとローカル設定に対応し、展開と保守を迅速化します。"
   }
  ],
  "sysHeading": "システム機能",
  "system": [
   {
    "img": "solution/58-sys-0.png",
    "h": "リモート設定",
    "p": "対応デバイスをバッチで設定できます（送信間隔、しきい値、展開固有のパラメーターを含む）。"
   },
   {
    "img": "solution/58-sys-1.png",
    "h": "リアルタイムモニタリング",
    "p": "Hitelecomはセンサーでデータを収集し、分析のためにクラウドプラットフォームに送信します。プラットフォームは傾向を分析し異常値を検出して、チームが保全を計画しダウンタイムを削減するのを支援します。"
   },
   {
    "img": "solution/58-sys-2.png",
    "h": "ルールベースの自動化",
    "p": "コントローラーは設定済みルールに基づいてセンサーデータに反応し、デバイスとサイト全体で自動応答を可能にします。"
   },
   {
    "img": "solution/58-sys-3.png",
    "h": "リモートファームウェア更新",
    "p": "対応デバイスのリモート一括OTAファームウェア更新をサポートし、展開を最新に保ち、現場訪問を削減します。"
   }
  ],
  "relHeading": "関連製品",
  "related": [
  ...
  "scenarios": [
   {
    "img": "solution/58-scen-0.jpg",
    "h": "インダストリー4.0",
    "p": "データ駆動の生産管理と自動化サポート"
   },
   {
    "img": "solution/58-scen-1.jpg",
    "h": "プロセスモニタリング",
    "p": "リアルタイムモニタリング、精密制御、強化された自動化"
   },
   {
    "img": "solution/58-scen-2.jpg",
    "h": "石油・ガス業界",
    "p": "油田生産の遠隔モニタリング：井戸元の圧力、ポンプ状態、集油管の漏洩"
   },
   {
    "img": "solution/58-scen-3.jpg",
    "h": "廃棄物焼却",
    "p": "焼却プロセス制御を最適化し、エネルギー効率を高め、環境汚染を削減します。"
   },
   {
    "img": "solution/58-scen-4.jpg",
    "h": "大型機械",
    "p": "状態監視は保全効率と資源利用率を向上させます"
   },
   {
    "img": "solution/58-scen-5.jpg",
    "h": "産業プラント",
    "p": "集中モニタリングは故障と予定外のダウンタイムを削減します"
   }
  ]
 },
 "65": {
  ...
  "intro": [
   {
    "img": "solution/65-intro-0.jpg",
    "h": "業界の課題",
    "p": "スマート農業は、接続されたセンシングを適用して農場運営をより生産的で資源効率的にします。限られた土地、気候変動、害虫圧に直面して、栽培者はIoTセンサー、気象データ、クラウド分析を組み合わせ、より的確な灌漑と作物管理を実現できます。Hitelecomはこれらのシステムにフィールドセンシングとコネクティビティ層を提供します。"
   },
   {
    "img": "solution/65-intro-1.jpg",
    "h": "ソリューション概要",
    "p": "Hitelecomのスマート農業ソリューションは、土壌センサー、気象ステーション、温度・湿度センサーを組み合わせ、フィールドデータをクラウドにアップロードして集中的なモニタリングと分析を行います。栽培者は圃場状況を継続的に可視化し、灌漑、施肥、作物管理の意思決定を支援されます。"
   }
  ],
  "archHeading": "ソリューションアーキテクチャ",
  "archImgs": [
  ...
  "system": [
   {
    "img": "solution/65-sys-0.png",
    "h": "精密灌漑",
    "p": "土壌水分と気象データは、栽培者が灌漑のタイミングと量を調整するのに役立ちます。"
   },
   {
    "img": "solution/65-sys-1.png",
    "h": "しきい値アラート",
    "p": "設定済みしきい値（例：土壌水分や温度）を超えるとアラートが発動し、チームは作物にストレスがかかる前に対応できます。"
   },
   {
    "img": "solution/65-sys-2.png",
    "h": "リアルタイムモニタリング",
    "p": "Hitelecomはセンサーでデータを収集し、分析のためにクラウドプラットフォームに送信します。プラットフォームは傾向を分析し異常値を検出して、栽培者に灌漑や圃場判断のためのタイムリーな情報を提供します。"
   },
   {
    "img": "solution/65-sys-3.png",
    "h": "リモートファームウェア更新",
  ...
  "scenarios": [
   ...
   },
   {
    "img": "solution/65-scen-1.jpg",
    "h": "コネクテッド牧場",
    "p": "家畜の健康と行動のリアルタイムモニタリングと管理"
   },
   {
    "img": "solution/65-scen-2.jpg",
    "h": "コネクテッドファーム",
    "p": "接続されたセンサーとデータ分析が精密灌漑と作物管理をサポート"
   },
   {
    "img": "solution/65-scen-3.jpg",
    "h": "養鶏",
    "p": "家禽の健康と行動を監視し、養殖の効率と品質を向上"
   },
   {
    "img": "solution/65-scen-4.jpg",
    "h": "海洋養殖",
  ...
  "intro": [
   {
    "img": "solution/64-intro-0.png",
    "h": "業界の課題",
    "p": "キャンパス担当チームは、多くの建物にわたって室内空気質、温湿度、エネルギー使用、ユーティリティ、安全システムを管理しています。手動点検と孤立したシステムは、タイムリーな可視性を制限します。"
   },
   {
    "img": "solution/64-intro-1.jpg",
    "h": "ソリューション概要",
    "p": "Hitelecomは環境センサー、ゲートウェイ、クラウド統合を組み合わせ、キャンパスモニタリングを一元化します。管理者は状況を確認し、アラートを設定し、対応データを既存プラットフォームに接続できます。"
   }
  ],
  "archHeading": "ソリューションアーキテクチャ",
  "archImgs": [
  ...
  "system": [
   {
    "img": "solution/64-sys-0.png",
    "h": "自動制御ルール",
    "p": "ルールは、センサー読取値が設定済みしきい値を超えた際に、接続機器（例：冷却）を調整します — プロジェクトに対応制御システムが統合されている場合。"
   },
   {
    "img": "solution/64-sys-2.png",
    "h": "リアルタイムモニタリング",
    "p": "Hitelecomはセンサーでデータを収集し、分析のためにクラウドプラットフォームに送信します。プラットフォームは傾向を分析し異常値を検出して、管理者が施設状況を追跡しアラートに対応するのを支援します。"
   },
   {
    "img": "solution/64-sys-3.png",
    "h": "アラーム通知",
    "p": "アラートを一元設定・管理します（複数条件トリガーや、対応展開向けのエスカレーションワークフローを含む）。"
   }
  ],
  "relHeading": "関連製品",
  "related": [
  ...
  "scenarios": [
   {
    "img": "solution/64-scen-0.jpg",
    "h": "キャンパス運営",
    "p": "キャンパス建物全体のエネルギー使用、室内空気質、施設状態を監視"
   },
   {
    "img": "solution/64-scen-1.jpg",
    "h": "キャンパス安全",
    "p": "リアルタイムモニタリングはキャンパス安全と緊急対応を強化します"
   },
   {
    "img": "solution/64-scen-2.jpg",
    "h": "研修室・実験室",
    "p": "実験室・作業場の環境条件と設備を、設定可能なアラートで監視"
   }
  ]
 },
 "60": {
  ...
  "intro": [
   {
    "img": "solution/60-intro-0.jpg",
    "h": "業界の課題",
    "p": "工業団地の運営者は、複数の建物にわたって環境条件、ユーティリティ、セキュリティシステム、設備、資産を管理しています。接続されていないシステムは、異常状態の特定と保全の調整を困難にします。"
   },
   {
    "img": "solution/60-intro-1.jpg",
    "h": "ソリューション概要",
    "p": "Hitelecomは、用途に応じて選定されたセンサーとゲートウェイを中央モニタリングプラットフォームに接続し、運営者に環境・エネルギー・安全・資産データの統一的なビューを提供します。設定可能なアラートとAPIが既存の団地管理ワークフローをサポートします。"
   }
  ],
  "archHeading": "ソリューションアーキテクチャ",
  "archImgs": [
  ...
  "system": [
   ...
   },
   {
    "img": "solution/60-sys-1.png",
    "h": "故障箇所の特定",
    "p": "診断機能はチームが故障デバイスを特定し、修理時間を短縮し、地図上でデバイス状態を確認するのに役立ちます。"
   },
   {
    "img": "solution/60-sys-2.png",
    "h": "ルールベースの自動化",
  ...
  "scenarios": [
   {
    "img": "solution/60-scen-0.jpg",
    "h": "工業団地",
    "p": "生産効率の向上と施設・設備の精密管理"
   },
   {
    "img": "solution/60-scen-1.jpg",
    "h": "商業ビル",
    "p": "ビル自動化とエネルギー効率最適化の実装"
   },
   {
    "img": "solution/60-scen-2.jpg",
    "h": "オフィスビル",
    "p": "現代のオフィス環境向けのインテリジェントな管理と運営"
   }
  ]
 },
 "59": {
  ...
  "intro": [
   {
    "img": "solution/59-intro-0.png",
    "h": "業界の課題",
    "p": "エネルギー事業者は、地理的に分散した資産の温度・圧力・振動・レベルについてタイムリーな可視性を必要としています。定期点検は発生しつつある故障を見逃し、高コストの現場訪問を必要とすることがあります。接続されたセンサーとリモートアラートは、チームが点検と保全に優先順位をつけるのに役立ちます。"
   },
   {
    "img": "solution/59-intro-1.jpg",
    "h": "ソリューション概要",
    "p": "Hitelecomは、用途に応じて選定されたセンサー、ゲートウェイ、セルラーまたはLoRaWANコネクティビティ、クラウド統合を組み合わせ、遠隔状態モニタリングを実現します。選択された構成に応じて、データはMQTTまたはAPIを通じてHitelecom Cloudまたはお客様のプラットフォームに送信できます。"
   }
  ],
  "archHeading": "ソリューションアーキテクチャ",
  "archImgs": [
  ...
  "scenarios": [
   {
    "img": "solution/59-scen-0.jpg",
    "h": "風力発電とエネルギー貯蔵",
    "p": "タービンと貯蔵システムの状態監視は保全計画をサポートします"
   },
   {
    "img": "solution/59-scen-1.jpg",
    "h": "再生可能エネルギー設備",
    "p": "再生可能エネルギー設備のリアルタイムモニタリングと制御"
   },
   {
    "img": "solution/59-scen-2.jpg",
    "h": "発電所",
    "p": "温度・圧力・振動・設備状態を監視し、保全計画を支援します。"
   }
  ]
 },
 "57": {
  ...
  "intro": [
   {
    "img": "solution/57-intro-0.jpg",
    "h": "業界の課題",
    "p": "都市の成長は、交通渋滞、環境圧力、老朽化インフラなどの課題をもたらします。接続されたセンシングは、都市運営者に道路、橋梁、パイプライン網、環境に関するリアルタイムデータを提供し、より的確な意思決定を支援します。Hitelecomはこれらのモニタリングシステムで使用されるフィールドセンサーとコネクティビティを提供します。"
   },
   {
    "img": "solution/57-intro-1.jpg",
    "h": "ソリューション概要",
    "p": "Hitelecomのスマートシティソリューションは、インフラモニタリング（マンホールカバー、橋梁、パイプライン、環境条件）を中央プラットフォームに接続します。運営者は異常状態のアラートを受け取り、ひとつのインターフェースから市内全域のインフラ状態を追跡できます。"
   }
  ],
  "archHeading": "ソリューションアーキテクチャ",
  "archImgs": [
  ...
  "system": [
   ...
   },
   {
    "img": "solution/57-sys-1.png",
    "h": "リアルタイムモニタリング",
    "p": "Hitelecomはセンサーでデータを収集し、分析のためにクラウドプラットフォームに送信します。プラットフォームは傾向を分析し異常値を検出して、オペレーターがインフラ状況を監視し点検を計画するのを支援します。"
   },
   {
    "img": "solution/57-sys-2.png",
    "h": "ルールベースの自動化",
  ...
  "scenarios": [
   {
    "img": "solution/57-scen-0.jpg",
    "h": "コネクテッド車両インフラ",
    "p": "屋外向けセンサーターミナルで道路脇・車庫インフラの状態を監視"
   },
   {
    "img": "solution/57-scen-1.jpg",
    "h": "物流とサプライチェーン",
    "p": "サイト間で資産を追跡し倉庫状況を監視"
   },
   {
    "img": "solution/57-scen-2.jpg",
    "h": "都市パイプライン",
    "p": "圧力、漏洩、レベル、動作状況を監視します。"
   },
   {
    "img": "solution/57-scen-3.jpg",
    "h": "水力発電施設",
  ...
  "intro": [
   {
    "img": "solution/66-intro-0.jpg",
    "h": "業界の課題",
    "p": "観光地や文化遺産は、構造物とコレクションを保護しながら、来訪者エリア、環境条件、分散施設を管理しなければなりません。手動点検では、緩やかな動きやミクロ気候の変化を見逃すことがあります。"
   },
   {
    "img": "solution/66-intro-1.jpg",
    "h": "ソリューション概要",
    "p": "Hitelecomは傾斜・振動・温度・湿度・距離など、用途に応じて選定されたセンサーをクラウドモニタリングと組み合わせます。チームは歴史的建造物、博物館、考古学サイト、来訪者インフラの傾向とアラートを確認できます。"
   }
  ],
  "archHeading": "ソリューションアーキテクチャ",
  "archImgs": [
  ...
  "scenarios": [
   {
    "img": "solution/66-scen-0.jpg",
    "h": "歴史的建造物",
    "p": "温度・湿度・構造傾斜を監視し、保存を支援します。"
   },
   {
    "img": "solution/66-scen-1.jpg",
    "h": "博物館とコレクション",
    "p": "温度・湿度・煙を追跡し、展示物とコレクションの保存を支援します。"
   },
   {
    "img": "solution/66-scen-2.jpg",
    "h": "考古学サイト",
    "p": "露出したサイトの環境条件と構造物の動きを監視します。"
   },
   {
    "img": "solution/66-scen-3.jpg",
    "h": "来訪者エリア",
    "p": "来訪者の流れと環境条件を監視し、サイト運営を支援します。"
   }
  ]
 },
 "67": {
  ...
  "intro": [
   {
    "img": "solution/67-intro-0.jpg",
    "h": "業界の課題",
    "p": "水道事業者は、分散した貯水池、ポンプ場、パイプライン、排水資産、処理施設を運営しています。遅延または不完全なフィールドデータは、異常なレベル・圧力・流量・水質状況への対応を遅らせる可能性があります。"
   },
   {
    "img": "solution/67-intro-1.jpg",
    "h": "ソリューション概要",
    "p": "Hitelecomは、用途に応じて選定されたレベル・圧力・環境などの対応センサーをクラウドまたはお客様のプラットフォームに接続します。設定可能なアラートとリモートデータアクセスが、チームの点検と保全の優先順位付けを支援します。"
   }
  ],
  "archHeading": "ソリューションアーキテクチャ",
  "archImgs": [
  ...
  "system": [
   ...
   },
   {
    "img": "solution/67-sys-1.png",
    "h": "リアルタイムモニタリング",
    "p": "Hitelecomはセンサーでデータを収集し、分析のためにクラウドプラットフォームに送信します。プラットフォームは傾向を分析し異常値を検出して、水道事業者が異常なレベル・流量・水質状況を特定するのを支援します。"
   },
   {
    "img": "solution/67-sys-2.png",
    "h": "ルールベースの自動化",
  ...
  "scenarios": [
   {
    "img": "solution/67-scen-0.jpg",
    "h": "水力発電ダム",
    "p": "ダムの水位、変位、傾斜、環境条件を監視します。"
   },
   {
    "img": "solution/67-scen-1.jpg",
    "h": "産業用水プラント",
    "p": "プロセス条件と設備状態を監視し、保全計画を支援します。"
   },
   {
    "img": "solution/67-scen-2.jpg",
    "h": "養殖業",
    "p": "養殖事業の水質・環境条件を監視します。"
   }
  ]
 }
}, es: {
...
{ ...solutionSeoBase, de: {
 ...
 "57": {
  "name": "スマートシティ",
  "title": "スマートシティ向けIoT | Hitelecom",
  "desc": "フィールドセンサー、セルラーまたはLoRaWANコネクティビティ、クラウドアラートで、都市の構造物・ユーティリティ・環境条件を監視します。"
 },
 "58": {
  "name": "産業用IoT",
  "title": "産業用IoTソリューション | 設備モニタリング | Hitelecom",
  "desc": "温度・圧力・振動・空気質センサー、リモートアラート、クラウドダッシュボードで産業設備とユーティリティを監視します。"
 },
 "59": {
  "name": "スマートエネルギー",
  "title": "スマートエネルギー向けIoT | Hitelecom",
  "desc": "モデル別の無線コネクティビティとクラウドアラートで、エネルギー資産の圧力・温度・振動・レベルを監視します。"
 },
 "60": {
  "name": "スマート工業団地",
  "title": "工業団地向けIoT | Hitelecom",
  "desc": "センサー、ゲートウェイ、設定可能なアラートで、工業団地の環境・エネルギー・セキュリティ・設備データを一元化します。"
 },
 "64": {
  "name": "スマートキャンパス",
  "title": "スマートキャンパス向けIoT | Hitelecom",
  "desc": "IoTセンサー、ゲートウェイ、クラウドプラットフォームで、キャンパスの空気質・温湿度などのデータを一元化します。"
 },
 "65": {
  "name": "スマート農業",
  "title": "スマート農業向けIoT | Hitelecom",
  "desc": "土壌センサーと気象ステーションをIoTコネクティビティと組み合わせ、灌漑・施肥・作物管理の意思決定を支援します。"
 },
 "66": {
  "name": "観光・文化遺産",
  "title": "観光・文化遺産向けIoT | Hitelecom",
  "desc": "歴史的建造物、博物館、考古学サイトの構造物の動きと環境条件を、センサーとクラウドアラートで監視します。"
 },
 "67": {
  "name": "スマート水管理",
  "title": "スマート水管理向けIoT | Hitelecom",
  "desc": "貯水池、ポンプ場、パイプライン、排水網の水位・圧力・流量・水質をリモートアラートで監視します。"
 }
}, es: {
 "57": {
