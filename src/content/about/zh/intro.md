	...
	<div class="indexmid">
		<Div class="pro_1_mid">
			<ul class="u5">
				...
				<li class="reveal">
					<a class="css3 on" href="/zh/about.html">
						企业简介
					</a>
				</li>
				<li class="reveal">
			...
			<select id="changeurl">
				...
				<option selected="selected"  value="/zh/about.html">
					企业简介
				</option> 
		...
		<!--<Div class="about_1_mid">
			<ul>
				...
				<li class="reveal">
					<div class="about_1_mid_mid">
						<div class="about_1_mid_mid_1">
							<p><span>8000</span><span>种</span></p>
						</div>
						<div class="about_1_mid_mid_2">
							智能能设备链接
						</div>
				...
				<li class="reveal">
					<div class="about_1_mid_mid">
						<div class="about_1_mid_mid_1">
							<p><span>1000</span><span>家</span></p>
						</div>
						<div class="about_1_mid_mid_2">
							全球品牌客户
						</div>
	...
	<Div class="indexmid">
		<div class="about_6_1">
			...
			<div class="about_6_1_right reveal">
				公司专注于创新研发，已获众多软件著作权与专利授权，且荣获高新技术企业认证<br>
宏太自有工厂，引进车规级电子生产线，全面通过ISO认证，确保产品与服务的卓越品质
			</div>
		</div>
