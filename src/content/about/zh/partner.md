...
<div class="clearfix pa_4">
	<div class="indexmid">
							...
							<div class="index_1_2 daxie reveal" style="font-size:16px; letter-spacing:0">
								宏太不仅深耕本土，更以开放的视野和国际化的战略布局，与合作伙伴一道确保无论身在何处的客户都能享受到我们的专业服务和优质产品
							</div>
	</div>
	...
	<div class="indexmid">
							...
							<div class="clearfix pa_5_1 reveal">
								...
								<ul>
									<li>
										<div>
											<input type="text" id="company" name="company" placeholder="公司名称" value="">
										</div>
									</li>
									<li>
										<div>
									...
									<li>
										<div>
											<input type="text" id="jobs" name="jobs" placeholder="职位" value="">
										</div>
									</li>
									<li>
										<div>
									...
									<li>
										<div>
											...
											<input type="hidden" value="智慧工业" id="types" name="types">
										</div>
									</li>
									<li>
										<div>
