			...
			<div class="cell_h">
				<Div class="indexmid">
					<Div class="nybanner_jj_mid">
						<h1 class="nybanner_jj_mid_1 reveal">Política de privacidad</h1>
	...
	<div class="indexmid">
		<Div class="pro_1_mid">
			...
			<select id="changeurl">
				...
				<option  selected="selected"  value="/es/about/privacy"> Política de privacidad </option> 
...
<div class="clearfix privacy_wrap">
	<div class="indexmid">
		<Div class="privacy_doc">
			...
			<p><strong>Formularios de consulta.</strong> Cuando usted envía un formulario de contacto o consulta, recopilamos los datos que proporciona: su nombre, número de teléfono, dirección de correo electrónico y el contenido de su mensaje (que puede incluir su empresa, aplicación y requisitos del proyecto).</p>
			<p><strong>Registros técnicos.</strong> Como la mayoría de los sitios web, nuestro proveedor de alojamiento (Cloudflare) procesa datos de conexión estándar, como la dirección IP, el tipo de navegador y las páginas solicitadas, para entregar y proteger el sitio. No utilizamos rastreadores publicitarios ni elaboramos ni vendemos perfiles de comportamiento.</p>

			<h2>2. Cómo usamos su información</h2>
			<ul>
				<li>Para responder a su consulta y comunicarnos con usted sobre productos, cotizaciones y soporte técnico;</li>
				<li>Para realizar gestiones precontractuales y ejecutar un contrato a petición suya;</li>
				<li>Para mantener la seguridad y la disponibilidad de este sitio web;</li>
			...
			<p>Nuestra sede está en Shanghái, China, y nuestros proveedores de servicios pueden operar en otros países. Al enviar un formulario, su información puede transferirse a estos lugares y procesarse en ellos, con la protección establecida en esta política.</p>
			...
			<p>Podemos actualizar esta política periódicamente. La fecha de &ldquo;Última actualización&rdquo; indica la versión vigente, y los cambios importantes se anunciarán en esta página.</p>
